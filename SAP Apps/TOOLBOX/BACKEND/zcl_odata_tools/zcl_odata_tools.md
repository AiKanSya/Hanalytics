# 🌸 [ZCL_ODATA_TOOLS](link)

> 🌺 Objectifs
>
> - [ ] Classe spécifique ABAP contenant des OData Tools

## 🌸 SAP GUI

#### 💮 **SE24 - ZCL_ODATA_TOOLS** :
...
![](./assets/Capture%20d’écran%202025-06-06%20155710.png)

![](./assets/Capture%20d’écran%202025-06-06%20155752.png)

![](./assets/Capture%20d’écran%202025-06-06%20155817.png)

![](./assets/Capture%20d’écran%202025-06-06%20155916.png)

</details>

<details>
  <summary>🍧 ABAP Source Code</summary>
...
```html
ZCL_ZLOG_RADIOFREQ_DPC_EXT
```

<details>
  <summary>🍧 ABAP Odata Class</summary>

```abap
* DECLARATIONS

DATA: lt_return   TYPE bapiret2_tab,
      lo_msg_cont TYPE REF TO /iwbep/if_message_container.
...
IF lt_return IS NOT INITIAL.
     zcl_odata_tools=>raise_busi_exception_from_bapi( it_bapi_messages = lt_return ).
ENDIF.
```
